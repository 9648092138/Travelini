...
public class Flight {
  ...
  private List<FlightIntermediateStop> intermediateStop = null;
  ...
  public Flight(String type, String id, String flightRef, Integer distance, Integer stops,
      ...
      String operatingCarrierName, List<String> equipment, FlightDeparture departure, FlightArrival arrival,
      List<FlightIntermediateStop> intermediateStop) {
    super();
    this.type = type;
    this.id = id;
  ...
  @JsonProperty("Departure")
  public void setFlightDeparture(FlightDeparture departure) {
    this.departure = departure;
  }
  ...
  @JsonProperty("Arrival")
  public void setFlightArrival(FlightArrival arrival) {
    this.arrival = arrival;
  }

  @JsonProperty("IntermediateStop")
  public List<FlightIntermediateStop> getFlightIntermediateStop() {
    return intermediateStop;
  }

  @JsonProperty("IntermediateStop")
  public void setIntermediateStop(List<FlightIntermediateStop> intermediateStop) {
    this.intermediateStop = intermediateStop;
  }
