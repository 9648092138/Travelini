...
public class CatalogOfferingsResponse {
  ...
  private List<FlightReferenceList> flightReferenceList = null;
  ...
  public CatalogOfferingsResponse(CatalogOfferings catalogOfferings, String transactionId,
      String traceId, Result result, List<FlightReferenceList> referenceList) {
    super();
    this.catalogOfferings = catalogOfferings;
    this.transactionId = transactionId;
    this.traceId = traceId;
    this.result = result;
    this.flightReferenceList = referenceList;
  }
  ...
  @JsonProperty("ReferenceList")
  public List<FlightReferenceList> getReferenceList() {
    return flightReferenceList;
  }

  @JsonProperty("ReferenceList")
  public void setReferenceList(List<FlightReferenceList> referenceList) {
    this.flightReferenceList = referenceList;
  }
