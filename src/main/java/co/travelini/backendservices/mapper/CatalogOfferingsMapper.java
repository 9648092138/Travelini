...
import co.travelini.backendservices.entity.CatalogOfferings;
import co.travelini.backendservices.entity.CatalogOfferingsResponse;
import  co.travelini.backendservices.entity.DefaultCurrency;
...
public class CatalogOfferingsMapper {
  ...
  private List<CatalogOffering> mapCatalogOfferinglist(LowFareSearchRsp lfsResponse, String view)
  {
   ...
   // System.out.println("Hello world" + airPricePointList);
