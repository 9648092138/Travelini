...
import co.travelini.backendservices.entity.CarrierPreference;
import co.travelini.backendservices.entity.SearchModifiersAir;
...
public class SearchModifiersMapper {
  ...
  private FlightType mapFlightType(SearchModifiersAir searchModifiers) {
    ...
    co.travelini.backendservices.entity.FlightType tsFlightType = searchModifiers
        .getFlightType();
  ...
  private FlightType mapConnectionType(
		  co.travelini.backendservices.entity.FlightType tsFlightType, FlightType flightType) {
