 ...
 * 2019-08-23T13:38:07.516+05:30
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "HotelService", 
                  wsdlLocation = "classpath:wsdl/hotel_v45_0/Hotel.wsdl",
                  targetNamespace = "http://www.travelport.com/service/hotel_v45_0") 
public class HotelService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelService");
    public final static QName HotelMediaLinksServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelMediaLinksServicePort");
    public final static QName RetrieveHotelSearchAvailabilityServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "RetrieveHotelSearchAvailabilityServicePort");
    public final static QName HotelDetailsServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelDetailsServicePort");
    public final static QName HotelSearchServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelSearchServicePort");
    public final static QName HotelUpsellSearchServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelUpsellSearchServicePort");
    public final static QName HotelSuperShopperServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelSuperShopperServicePort");
    public final static QName HotelRulesServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelRulesServicePort");
    public final static QName HotelSearchAvailabilityAsynchServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelSearchAvailabilityAsynchServicePort");
    public final static QName HotelKeywordsServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelKeywordsServicePort");
    public final static QName HotelRetrieveServicePort = new QName("http://www.travelport.com/service/hotel_v45_0", "HotelRetrieveServicePort");
    static {
        URL url = HotelService.class.getClassLoader().getResource("wsdl/hotel_v45_0/Hotel.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(HotelService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:wsdl/hotel_v45_0/Hotel.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
