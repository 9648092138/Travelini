 ...
 *       &lt;attribute name="Type" type="{http://www.travelport.com/schema/common_v45_0}typeEmailType" /&gt;
 *       &lt;attribute name="Comment" type="{http://www.travelport.com/schema/common_v45_0}typeEmailComment" /&gt;
