 ...
 *       &lt;attribute name="Type" type="{http://www.travelport.com/schema/air_v45_0}typeItinerary" /&gt;
 *       &lt;attribute name="Option" type="{http://www.travelport.com/schema/air_v45_0}typeItineraryOption" /&gt;
