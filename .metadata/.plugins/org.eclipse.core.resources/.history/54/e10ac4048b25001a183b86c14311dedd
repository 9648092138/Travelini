 ...
 *       &lt;attribute name="CarrierLocatorCode" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeLocatorCode" /&gt;
 *       &lt;attribute name="ProviderCode" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeProviderCode" /&gt;
 *       &lt;attribute name="ProviderLocatorCode" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeProviderLocatorCode" /&gt;
 *       &lt;attribute name="UniversalLocatorCode" type="{http://www.travelport.com/schema/common_v45_0}typeLocatorCode" /&gt;
