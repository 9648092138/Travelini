 ...
 *       &lt;attribute name="VoucherType" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeVoucherType" /&gt;
 ...
 *       &lt;attribute name="Number" type="{http://www.travelport.com/schema/common_v45_0}StringLength1to16" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
