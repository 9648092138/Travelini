 ...
 *           &lt;/sequence&gt;
 *           &lt;element name="TCRNumber" type="{http://www.travelport.com/schema/air_v45_0}typeTCRNumber"/&gt;
 *         &lt;/choice&gt;
 *         &lt;element name="BookingTravelerRef" type="{http://www.travelport.com/schema/common_v45_0}typeRef" maxOccurs="999"/&gt;
 *       &lt;/sequence&gt;
...
public class RefundFailureInfo {
    ...
    @XmlElement(name = "Name", namespace = "http://www.travelport.com/schema/common_v45_0")
    protected Name name;
