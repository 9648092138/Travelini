 ...
 *       &lt;attribute name="Name" use="required" type="{http://www.travelport.com/schema/air_v45_0}typeBillingDetailsName" /&gt;
 *       &lt;attribute name="DataType" use="required" type="{http://www.travelport.com/schema/air_v45_0}typeBillingDetailsDataType" /&gt;
