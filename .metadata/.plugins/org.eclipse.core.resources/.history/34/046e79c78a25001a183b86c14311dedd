...
import com.travelport.schema.common_v45_0.IndustryStandardSSR;
 ...
 *         &lt;element name="SSRRules" type="{http://www.travelport.com/schema/common_v45_0}ServiceRuleType" maxOccurs="999" minOccurs="0"/&gt;
 *         &lt;element ref="{http://www.travelport.com/schema/common_v45_0}IndustryStandardSSR" maxOccurs="999" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class AvailableSSR {
    ...
    @XmlElement(name = "IndustryStandardSSR", namespace = "http://www.travelport.com/schema/common_v45_0")
