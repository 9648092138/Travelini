 ...
 *       &lt;attribute name="CheckInDate" type="{http://www.travelport.com/schema/common_v45_0}typeDate" /&gt;
 *       &lt;attribute name="CheckOutDate" type="{http://www.travelport.com/schema/common_v45_0}typeDate" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
