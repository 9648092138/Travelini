...
import com.travelport.schema.common_v45_0.LoyaltyProgram;
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.travelport.com/schema/common_v45_0}LoyaltyProgram" maxOccurs="999" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="Amount" type="{http://www.travelport.com/schema/common_v45_0}typeMoney" /&gt;
 *       &lt;attribute name="Percent" type="{http://www.travelport.com/schema/common_v45_0}typePercentageWithDecimal" /&gt;
...
public class AvailableDiscount {
    ...
    @XmlElement(name = "LoyaltyProgram", namespace = "http://www.travelport.com/schema/common_v45_0")
