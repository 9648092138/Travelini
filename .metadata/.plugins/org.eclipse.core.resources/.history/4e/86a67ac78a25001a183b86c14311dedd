 ...
 *         &lt;simpleType&gt;
 *           &lt;restriction base="{http://www.travelport.com/schema/common_v45_0}typeIATACode"&gt;
 *           &lt;/restriction&gt;
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
 *       &lt;attribute name="Date"&gt;
 ...
 *         &lt;simpleType&gt;
 *           &lt;restriction base="{http://www.travelport.com/schema/air_v45_0}typeBooking"&gt;
 *           &lt;/restriction&gt;
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
 *       &lt;attribute name="DisplayCategory"&gt;
 *         &lt;simpleType&gt;
 *           &lt;restriction base="{http://www.travelport.com/schema/air_v45_0}typeDisplayCategory"&gt;
 *           &lt;/restriction&gt;
 *         &lt;/simpleType&gt;
 *       &lt;/attribute&gt;
