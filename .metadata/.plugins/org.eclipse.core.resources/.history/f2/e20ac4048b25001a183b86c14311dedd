 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.travelport.com/schema/common_v45_0}HostToken" maxOccurs="999"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class HostTokenList {
    ...
    @XmlElement(name = "HostToken", namespace = "http://www.travelport.com/schema/common_v45_0", required = true)
