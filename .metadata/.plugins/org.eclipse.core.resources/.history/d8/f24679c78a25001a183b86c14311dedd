...
import com.travelport.schema.common_v45_0.TypeReqSeat;
 ...
 *       &lt;attribute name="SeatType" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeReqSeat" /&gt;
