 ...
 *       &lt;attribute name="PassengerDetailRef" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeRef" /&gt;
 *       &lt;attribute name="FareBasis" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeFareBasisCode" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
