 ...
 * &lt;complexType&gt;
 *   &lt;complexContent&gt;
 *     &lt;extension base="{http://www.travelport.com/schema/air_v45_0}AirSearchReq"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.travelport.com/schema/common_v45_0}SearchPassenger" maxOccurs="18" minOccurs="0"/&gt;
    ...
    extends AirSearchReq
{
    ...
    @XmlElement(name = "SearchPassenger", namespace = "http://www.travelport.com/schema/common_v45_0")
