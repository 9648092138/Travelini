 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;choice&gt;
 *                   &lt;element ref="{http://www.travelport.com/schema/common_v45_0}ResponseMessage" minOccurs="0"/&gt;
 *                   &lt;element ref="{http://www.travelport.com/schema/air_v45_0}OptionalServiceRef" minOccurs="0"/&gt;
 *                 &lt;/choice&gt;
...
public class ServiceAssociations {
    ...
    public static class ApplicableSegment {
        ...
        @XmlElement(name = "ResponseMessage", namespace = "http://www.travelport.com/schema/common_v45_0")
