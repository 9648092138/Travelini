 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element ref="{http://www.travelport.com/schema/common_v45_0}Airport"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
public class SpecificTimeTable {
    ...
    public static class FlightDestination {
        ...
        @XmlElement(name = "Airport", namespace = "http://www.travelport.com/schema/common_v45_0", required = true)
