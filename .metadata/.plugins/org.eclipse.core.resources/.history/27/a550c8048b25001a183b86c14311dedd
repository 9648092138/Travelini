 ...
 *       &lt;attGroup ref="{http://www.travelport.com/schema/common_v45_0}attrAgentOverride"/&gt;
 ...
 *       &lt;attribute name="BranchCode" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeBranchCode" /&gt;
