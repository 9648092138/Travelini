 ...
 *       &lt;choice&gt;
 *         &lt;element name="Amount" type="{http://www.travelport.com/schema/common_v45_0}typeMoney"/&gt;
 *         &lt;element name="Percent" type="{http://www.w3.org/2001/XMLSchema}float"/&gt;
 *       &lt;/choice&gt;
 *       &lt;attribute name="AdjustedTotalPrice" use="required" type="{http://www.travelport.com/schema/common_v45_0}typeMoney" /&gt;
 *       &lt;attribute name="ApproximateAdjustedTotalPrice" type="{http://www.travelport.com/schema/common_v45_0}typeMoney" /&gt;
